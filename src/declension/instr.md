...
|序号|作用|例句|解释|
|-|-|-|-|
|1|施动者用它作为手段完成一个行动，这个手段用具格。|cakkhunā rūpaṃ passati.|人用眼睛观色。|
|2|交通工具使用具格。|yānena gacchati.|他乘车前行。|
|3|具格也表示原因或理由。|vijjāya vasati.|他为了知识而生活。|
|4|交易价格使用具格。|satasahassena vikiṇitvā.|用十万金钱买下。|
|5|具格也表示身肢残缺。|akkhinā so kāṇo.|他瞎了一只眼。|
|6|表示出生、世系、起源和性质的这些词用具格。|jātiyā khattiyo buddho.|佛陀出身剎帝利。|
|7|具格表示所用时间。|ekena māsena nagaraṃ gacchi.|他去城市一个月。|
|8|具格表示所处时间。|tena samayena.|那时。|
|9|具格表示同伴，而且一般与saha（一起）、saddhiṃ（一起）结合使用。|nisīdi bhagavā saddhiṃ bhikkhusaṅghena.<br>puttena saha dhanavā pitā.<br>（saha有时表示“同等”）|世尊和比库僧团坐在一起。<br>一位父亲与他的儿子同样富有。|
|10|表示“有什么用”，事情用具格，人用为格。|kin nu me buddhena.|佛对我有什么用？|
|11|attho（愿望），愿望的对象用具格，人用为格。|maṇinā me attho.|我想要一颗摩尼珠。|
|12|alaṃ（足够）支配具格。|alaṃ idha vāsena.|在这里已住够了。|
|13|vinā支配具格。|vinā dosena.|没有错误。|
|14|表示“分离”的词一般与具格组合|piyehi vippayogo dukkho.|与所爱者分离是痛苦的。|
|15|表示“运送、携带、取来”等的动词，携带的部位使用具格。|sisena dārukalāpaṃ ucchaṅgena paṇṇam ādāya.|她头上顶着一捆柴火，臀部系着蔬菜。|
|16|具格也表示特征。|gottena gotamo.|乔达摩氏族|
...
>1. 表達動作的作者,或執行動作所使用的工具要用具格:－ cakkhuna rupaj passati [他(人)以眼見色, (one) sees forms with the eye]; － hatthena kammaj karoti [他(人)以手做工(one) does work with the hands]; － dasena kato (由奴隸所完成, done by the slave.)
...
>8. 表達時間: － divasena patto[一日間到達, arrived in one day,Divasa【m】日子。]－ekena masena nagaraj gacchi (他一個月前進城了, he went to the city in a month.)
>9. 也使用於時間,在那時候: tena samayena (當時, at that time...)
>10. 表達一起的伴,且通常要與不變化詞saha或saddhij (與、俱): －nisidi bhagava saddhij bhikkhusavghena (佛陀與比丘僧眾共同坐, the Blessed One sat together with the assembly of the monks.)
...
>13. 單字alaj (夠了)亦接用具格: －alaj idha vasena (在這裡住夠了,enough of living here) －alaj buddhena (佛陀對我是足夠的,Buddha is sufficient for me.)
>14. 指稱”分離”的字彙句法一般習慣上用具格: － piyehi vippayogo dukkho (愛別離苦, separation from those we love is painful. Vippayoga【m.】分離。 )
>15. 不變化詞: saha, saddhij, samaj (俱); vina(沒有,除了)接用具格: [vinadosena (沒有過失, without fault; Dosa【m.】過失、煩惱。]
註: saha,有時表示”平等”: puttena saha dhanava pita (兒子像父親一樣富有)
>16. 動詞意思為”運送,帶,拿”等等,攜帶的位置(部位)用具格: － sisena頭頂 darukalapaj ucchavgena pannam adaya [她頭頂木柴,腰後繫取綠葉, taking a bunch of firewood on her head and greens at her hips) sisena頭,Ucchavga,【m.】膝蓋,腰臀部; panna樹葉; ]
>17. 具格經常是作副詞使用(見前。) 
>18. 具格也經常接許多介系詞。
>---
